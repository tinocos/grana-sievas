    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index.php" class="logo">
          <!-- mini logo -->
          <div class="logo-mini">
            <span class="light-logo"><img src="<?php echo base_url(); ?>/images/logo-grana.png" alt="logo"></span>
            <span class="dark-logo"><img src="<?php echo base_url(); ?>/images/logo-grana.png" alt="logo"></span>
          </div>
          <!-- logo-->
          <div class="logo-lg">
            <span class="light-logo"><img src="<?php echo base_url(); ?>/images/logo-grana.png" alt="logo"></span>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown messages-menu">
                ...
                <ul class="dropdown-menu animated bounceIn">
                  ...
                  <li class="header">
                    <div class="p-20 bg-light">
                      <div class="flexbox">
                        ...
                        <div>
                          <a href="index.php#" class="text-danger">Clear All</a>
                        </div>
                      </div>
                    </div>
                  </li>
                  ...
                  <li class="footer">				  
                    <a href="index.php#" class="bg-light">See all e-Mails</a>
                  </li>
                </ul>
              </li>
              <!-- Notifications -->
              <li class="dropdown notifications-menu">
                ...
                <ul class="dropdown-menu animated bounceIn">
                  ...
                  <li class="footer">
                    <a href="index.php#" class="bg-light">View all</a>
                  </li>
                </ul>
              </li>
              <!-- Tasks-->
              <li class="dropdown tasks-menu">
                ...
                <ul class="dropdown-menu animated bounceIn">
                  ...
                  <li class="footer">
                    <a href="index.php#" class="bg-light">View all tasks</a>
                  </li>
                </ul>
              </li>	
              ...
              <li class="dropdown user user-menu">
                <a href="index.php#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo base_url();?>/images/avatar/7.jpg" class="user-image rounded-circle" alt="User Image">
                </a>
                <ul class="dropdown-menu animated flipInX">
                  <!-- User image -->
                  <li class="user-header bg-img" style="background-image: url(http://ultimatepro-admin-templates.multipurposethemes.com/<?php echo base_url();?>/images/user-info.jpg)" data-overlay="3">
                    <div class="flexbox align-self-center">					  
                      <img src="<?php echo base_url();?>/images/avatar/7.jpg" class="float-left rounded-circle" alt="User Image">					  
